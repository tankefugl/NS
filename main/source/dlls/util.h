...
extern void NetworkMeterMessageBegin(int msg_dest, int msg_type, const float* pOrigin, edict_t* ed);

inline void MESSAGE_BEGIN( int msg_dest, int msg_type, const float *pOrigin, entvars_t *ent ) 
{
	NetworkMeterMessageBegin(msg_dest, msg_type, pOrigin, ENT(ent));
}
inline void MESSAGE_BEGIN( int msg_dest, int msg_type, const float *pOrigin = NULL, edict_t* ed = NULL) 
{
	NetworkMeterMessageBegin(msg_dest, msg_type, pOrigin, ed);
}
...
extern void			UTIL_Error				( CBaseEntity *pEntity, const char *pMessage );
...
// Leave last parameter to make the same as pEntity
